...
<template>
  <nav aria-label="pagianation" role="navigation" class="mb-5 flex justify-between mt-5">
    ...
    <button
      @click="nextPage()"
      class="aria-disabled:cursor-not-allowed aria-disabled:bg-transparent aria-disabled:text-heavy-metal-800 aria-disabled:shadow-none px-2 py-1 bg-heavy-metal-700 cursor-pointer hover:bg-heavy-metal-800 text-white font-medium rounded-2xl shadow-md hover:shadow-lg"
